...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_iku7kkm', 'template_9mgg188', form.current, 'DmJZUbQN2NYTO6mH2')
      .then((result) => {
        setPending(false);
  ...
  return (
    <section id="contact" className='flex flex-col md:h-screen text-white py-10 justify-center md:justify-start md:ml-20 m-10' >
      <div className='text-center mt-8 md:text-start md:text-4xl'>
        ...
        <div
          class="max-w-screen-xl mt-5 px-4 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-8 lg:px-16 xl:px-32 py-8 md:py-8 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
          <div class="flex flex-col justify-between">
            <div>
              <h2 class="text-2xl lg:text-4xl font-bold leading-tight">Lets talk about everything!</h2>
              <div class="text-gray-700  mt-2 lg:mt-8 text-sm lg:text-xl">
                Hate forms? Send me an <span class="underline"><a href="mailto:akshyatpatra@gmail.com?subject=Through%20Portfolio&body=Hello%20Akshyat%2C%0D%0A%0D%0AI%20came%20across%20your%20impressive%20portfolio%20and%20I'm%20impressed%20by%20your%20expertise%20in%20web%2Fapp%20development.%20I'm%20reaching%20out%20because%20I'm%20interested%20in%20working%20with%20you%20on%20a%20project%20that%20I%20believe%20aligns%20with%20your%20skills%20and%20experience.%0D%0A%0D%0AThank%20you%20for%20your%20time%20and%20consideration.%20I%20look%20forward%20to%20hearing%20back%20from%20you%20soon.%0D%0A%0D%0ABest%20regards%2C%0D%0A%5BMay%20I%20ask%20for%20your%20name%2C%20please%3F%5D" data-ajax="false" target="_blank">email</a></span> instead.
              </div>
            </div>
              ...
              <svg class="w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <g opacity="0.1">
                  ...
                  <path
                    ...
                    transform="translate(-52 -162.63)" fill="#0891b2" />
                  <path
                ...
                <ellipse cx="548" cy="493.13" rx="548" ry="8.86" fill="#0891b2" opacity="0.1" />
                <ellipse cx="548" cy="565.88" rx="548" ry="8.86" fill="#0891b2" opacity="0.1" />
                <ellipse cx="548" cy="341.3" rx="548" ry="8.86" fill="#0891b2" opacity="0.1" />
                <ellipse cx="548" cy="417.21" rx="548" ry="8.86" fill="#0891b2" opacity="0.1" />
                <path
                  ...
                  transform="translate(-52 -162.63)" fill="#0891b2" opacity="0.1" />
                <path
          ...
          <form class="form-container" ref={form} onSubmit={sendEmail}>
            <div>
              ...
              <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline text-lg"
                type="text"
                name="name"
                placeholder="Akshyat Patra" required />
            </div>
            <div class="mt-2">
              ...
              <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline text-lg"
                ...
                name='email'
                placeholder='akshyatpatra@gmail.com' required />
            </div>
            <div class="mt-2">
              <span class="uppercase text-sm text-gray-600 font-bold">Message</span>
              <textarea
                class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline resize-x-none text-lg"
                name='message'
                placeholder='Write your message...' required ></textarea>
            </div>
            <div class="mt-2">
              <button
                class="uppercase text-sm font-bold tracking-wide bg-cyan-700 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline"
